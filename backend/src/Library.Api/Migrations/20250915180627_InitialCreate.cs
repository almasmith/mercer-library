        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Books_Rating_Range", "Rating >= 1 AND Rating <= 5");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookReads_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookReads_BookId_OccurredAt",
                table: "BookReads",
                columns: new[] { "BookId", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_BookReads_UserId_OccurredAt",
                table: "BookReads",
                columns: new[] { "UserId", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Books_OwnerUserId_Genre",
                table: "Books",
                columns: new[] { "OwnerUserId", "Genre" });

            migrationBuilder.CreateIndex(
                name: "IX_Books_OwnerUserId_PublishedDate",
                table: "Books",
                columns: new[] { "OwnerUserId", "PublishedDate" });
